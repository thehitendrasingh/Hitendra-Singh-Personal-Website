  ...
  return (
    <div className="pb-20 pt-10 space-y-24">
      ...
      <section className="text-center pb-12">
         <a href="/Hitendra%20Singh%20Product%20Manager%20Resume.pdf" target="_blank" rel="noopener noreferrer" className="group relative inline-flex items-center gap-3 px-8 py-4 bg-neutral-900 text-white rounded-xl font-bold shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
