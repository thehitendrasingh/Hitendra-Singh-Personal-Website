...
const Projects: React.FC = () => {
  ...
  return (
    <div className="pb-20 pt-10">
      ...
      <section className="mb-16 max-w-5xl mx-auto px-4">
        ...
        <GlowCard glowColor="teal" className="p-8 md:p-12 relative overflow-hidden group">
           ...
           <div className="absolute inset-0 z-0">
             <img 
               src="https://images.unsplash.com/photo-1544367563-12123d895e29?auto=format&fit=crop&q=80&w=1200" 
               alt="Mannsukh Background" 
               className="w-full h-full object-cover opacity-10 transition-transform duration-700 group-hover:scale-105"
             />
           ...
           <div className="relative z-10">
              ...
              <div className="flex flex-wrap gap-4">
                 <button className="px-6 py-3 bg-neutral-900 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all flex items-center gap-2">
                    View Landing Page <ExternalLink size={16} />
                 </button>
                 <button className="px-6 py-3 border border-neutral-200 text-neutral-700 font-bold rounded-xl hover:bg-neutral-50 transition-all flex items-center gap-2">
                    View Prototype <Layers size={16} />
                 </button>
              </div>
           </div>
        </GlowCard>
      ...
      {/* 3. SECONDARY PROJECT: CAREERMITRA */}
        ...
        <GlowCard glowColor="purple" className="p-8 relative overflow-hidden group">
           ...
           <div className="flex flex-col md:flex-row gap-8 relative z-20">
              ...
              <div className="flex-grow">
                 <h3 className="text-2xl font-bold text-neutral-900 mb-2">CareerMitra AI (Custom GPT)</h3>
                 <p className="text-neutral-600 mb-6 leading-relaxed">
                   CareerMitra AI is a custom-built GPT designed to help job seekers improve resumes, interview prep, PM thinking, and career clarity.
                 </p>
                 ...
                 <button className="px-5 py-2.5 bg-accent-violet/10 text-accent-violet font-bold rounded-lg hover:bg-accent-violet hover:text-white transition-all flex items-center gap-2">
                    Try CareerMitra AI <Zap size={16} />
                 </button>
              </div>
           </div>
        </GlowCard>
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <GlowCard glowColor="blue" className="p-6 flex flex-col h-full relative overflow-hidden group">
               ...
               <div className="flex items-center justify-between mt-auto relative z-10">
                  ...
                  <button className="text-sm font-bold text-accent-sky hover:underline flex items-center">
                     View Prototype <ArrowRight size={14} className="ml-1" />
                  </button>
               </div>
            </GlowCard>
            ...
            <GlowCard glowColor="teal" className="p-6 flex flex-col h-full relative overflow-hidden group">
               ...
               <div className="flex items-center justify-between mt-auto relative z-10">
                  ...
                  <button className="text-sm font-bold text-accent-emerald hover:underline flex items-center">
      ...
      <section className="text-center">
        <Link 
          to="/portfolio" 
          className="inline-flex items-center px-8 py-4 bg-neutral-900 text-white rounded-xl font-bold shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group"
        >
          View Case Studies <ArrowRight size={18} className="ml-2 group-hover:translate-x-1 transition-transform" />
        </Link>
      </section>
